...
function validateSkillItem(system, errors, warnings) {
  ...
  // Check for both old and new field names
  const hasOldBonus =
    system.roll_bonus !== undefined || system.keep_bonus !== undefined || system.total_bonus !== undefined;
  const hasNewBonus =
    system.rollBonus !== undefined || system.keepBonus !== undefined || system.totalBonus !== undefined;
