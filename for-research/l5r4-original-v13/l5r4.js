...
Hooks.once("init", function () {
  ...
  foundry.documents.collections.Actors.registerSheet("l5r4", L5R4PcSheet, { types: ["pc"], makeDefault: true });
  foundry.documents.collections.Actors.registerSheet("l5r4", L5R4NpcSheet, { types: ["npc"], makeDefault: true });
